...
load("~/Desktop/IntroR/Data/Cours3.RData")
...
**Remarques importantes**
  ...
  2. Certaines mesures sont sensibles aux composantes connexes : si le graphe est non connexe, les mesures de **betweeneness()** et **closeness()** peuvent retourner des valeurs biaisées.
  3. Certaines mesures comme **hub/authority** ne s'appliquent que dans les réseaux orientés.</div>
